...
const Recipe = ({recipe}) => {
  ...
  const handleClose = () => {
    ...
    // shows and formats the ingredients
  ...
  return ( 
    <div className="col-md-4 mb-3">
      <div className="card">
        ...
        <img className="card-image-top" src={recipe.strDrinkThumb} 
        alt={`Img from ${recipe.strDrink}`} />

        <div className="card-body">
          <button
            type="button"
            className="btm btn-block btn-primary"
            onClick={() => {
          ...
          >
              <div className={classes.paper} style={modalStyle}>
                  ...
                  <img className="img-fluid my-4" src={information.strDrinkThumb} alt=""></img>
